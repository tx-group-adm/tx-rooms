...
const homeBuilder = (buildingObj = buildings.STAUFFACHERQUAI_8) => {
    ...
    const commandExtension = process.env.STAGE === "dev" ? "-dev" : "";
    ...
    return {
        ...
        blocks: [
            ...
            // },
            {
                ...
                text: {
                    type: "mrkdwn",
                    text: "Click on one of the buttons below to see the room directory for each building.",
                },
            },
            ...
            },
            {
                ...
                elements: [
                    {
                        type: "mrkdwn",
                        text: `- *Tip #1:* Search for rooms with the slash command \`/rooms${commandExtension}\` (or Shortcut) in any Slack channel.\n - *Tip #2:* You can even search for partial room names.\n`,
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                elements: [
                    {
                        type: "mrkdwn",
                        text: "Made with ❤️ by *Michael Wuergler* so he can stop getting lost at work. | <https://github.com/tamedia-pmd/tx-rooms/issues|Report a Problem>",
                    },
                ],
            },
        ],
